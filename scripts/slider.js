document.addEventListener("DOMContentLoaded", function () {
  const slidesData = [
    ...
    { src: "media/img/main-page/slider-photo-10.png", alt: "" },
    { src: "media/img/main-page/slider-photo-11.png", alt: "" },
    { src: "media/img/main-page/slider-photo-12.png", alt: "" },
    { src: "media/img/main-page/slider-photo-13.png", alt: "" },
    { src: "media/img/main-page/slider-photo-14.png", alt: "" },
    { src: "media/img/main-page/slider-photo-15.png", alt: "" },
    { src: "media/img/main-page/slider-photo-16.png", alt: "" },
    { src: "media/img/main-page/slider-photo-17.png", alt: "" },
    { src: "media/img/main-page/slider-photo-18.png", alt: "" },
    { src: "media/img/main-page/slider-photo-19.png", alt: "" },
    { src: "media/img/main-page/slider-photo-20.png", alt: "" },
    { src: "media/img/main-page/slider-photo-21.png", alt: "" },
    { src: "media/img/main-page/slider-photo-22.png", alt: "" },
    { src: "media/img/main-page/slider-photo-23.png", alt: "" },
    { src: "media/img/main-page/slider-photo-24.png", alt: "" },
    { src: "media/img/main-page/slider-photo-25.png", alt: "" },
    { src: "media/img/main-page/slider-photo-26.png", alt: "" },
    { src: "media/img/main-page/slider-photo-27.png", alt: "" },
    { src: "media/img/main-page/slider-photo-28.png", alt: "" },
    { src: "media/img/main-page/slider-photo-29.png", alt: "" },
    { src: "media/img/main-page/slider-photo-30.png", alt: "" },
    { src: "media/img/main-page/slider-photo-31.png", alt: "" },
    { src: "media/img/main-page/slider-photo-32.png", alt: "" },
    { src: "media/img/main-page/slider-photo-33.png", alt: "" },
    { src: "media/img/main-page/slider-photo-34.png", alt: "" },
    { src: "media/img/main-page/slider-photo-35.png", alt: "" },
    { src: "media/img/main-page/slider-photo-36.png", alt: "" },
    { src: "media/img/main-page/slider-photo-37.png", alt: "" },
    { src: "media/img/main-page/slider-photo-38.png", alt: "" },
  ];
